<?php
$this->layout('../../layouts/layout', ['title' => 'Ikasa Muebles|Carrito']); ?>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="cart-table table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td class="pro-thumbnail"><a href="#"><img class="img-fluid" src="<?= URL . 'assets/img/cart/cart1.png' ?>" alt="Product" /></a></td>
                                ...
                                <tr>
                                    <td class="pro-thumbnail"><a href="#"><img class="img-fluid" src="<?= URL . 'assets/img/cart/cart2.png' ?>" /></a></td>
                                ...
                                <tr>
                                    <td class="pro-thumbnail"><a href="#"><img class="img-fluid" src="<?= URL . 'assets/img/cart/cart3.png' ?>" alt="Product" /></a></td>
                                ...
                                <tr>
                                    <td class="pro-thumbnail"><a href="#"><img class="img-fluid" src="<?= URL . 'assets/img/cart/cart4.png' ?>" alt="Product" /></a></td>
