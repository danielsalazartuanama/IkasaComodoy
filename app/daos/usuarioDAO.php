...
class UsuarioDAO extends Dao
{
    ...
    public function getAll(bool $estado)
    {
        ...
        clave,correo,fcreacion,feliminacion FROM usuario  where estado=?";
    ...
    public function get(int $id)
    {
        if ($id > 0) {
            $sql = "SELECT idusuario,idtipo,apellidos,nombres,direccion,telf,usuario,
            clave,correo,fcreacion,feliminacion,estado FROM usuario WHERE idusuario=?";
            $stmt = $this->pdo->prepare($sql);
    ...
    {
        $sql = "INSERT INTO usuario(idtipo,apellidos,nombres,direccion,telf,usuario,
    ...
    {
        $sql = "UPDATE  usuario SET idtipo=:idtipo,apellidos=:apellidos,nombres=:nombres,direccion=:direccion,telf=:telf,usuario=:usuario,
