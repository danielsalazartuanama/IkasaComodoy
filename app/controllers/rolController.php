...
class RolController extends Controller
{
    ...
    {
        $this->loadDirectoryTemplate('rol');
        $this->loadDAO('rol');
    }
    ...
    public function save()
    {
        ...
        if ($status == true) {
            $obj = new stdClass();           
            $obj->IdRol = isset($_POST['idrol']) ? $_POST['idrol'] : 0;
